            ...
            <div class="card">
                <div class="card-header ">
                    <div class="text-right col-md-12">
                        <a href="{{route("admin.user.export")}}" class="btn btn-primary mr-2">Xuất excel</a>
                    ...
                    <div class="table-responsive">
                        <table id="post-table" class="table table-striped table-bordered text-nowrap w-100">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p">SBD</th>
                                <th class="wd-15p">SĐT</th>
{{--                                <th class="wd-15p">Email</th>--}}
                                <th class="wd-15p">Loại</th>
                                <th class="wd-15p">Ngày kết thúc</th>
